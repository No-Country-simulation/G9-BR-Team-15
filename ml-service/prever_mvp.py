"""
EnergiAI - prever_mvp.py
Modelo MVP, criado apenas para atender ao endpoint OBRIGATÓRIO do edital, com os
5 campos exatos: consumo_kwh, uso_horario_pico, quantidade_equipamentos, tipo_imovel, horas_alto_consumo.

Este NÃO é o modelo principal do projeto -- o modelo principal (mais completo, usado pelo
dashboard e pela análise de Ciência de Dados) continua sendo prever.py, sem alterações.
"""
